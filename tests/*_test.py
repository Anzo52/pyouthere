...
def test_print_files_and_count(with_people, no_people, expected_output, capsys):
    # Act
...
@pytest.mark.parametrize("dir_path, with_people, no_people, expected_output", [
    ("path/to/dir", ["file1.jpg", "file2.jpg"], ["file3.jpg", "file4.jpg"], "Files with people:\nfile1.jpg\nfile2.jpg\nFiles without people:\nfile3.jpg\nfile4.jpg\nFiles with people: 2\nFiles without people: 2\nTotal files: 4\n"),
], ids=["happy-path"])
@patch("main.select_dialog")
@patch("main.detect_in_dir")
@patch("main.to_org")
@patch("main.print_files_and_count")
def test_process_directory(mock_print_files_and_count, mock_to_org, mock_detect_in_dir, mock_select_dialog, dir_path, with_people, no_people, expected_output, capsys):
    # Arrange
...
def test_select_dialog_and_detect_people(mock_detect_people, mock_select_dialog, file_path, detect_result, expected_output, capsys):
    # Arrange
